...
<main class="mx-auto min-h-screen max-w-2xl px-4 py-6 sm:px-6 sm:py-10">
	<div class="border border-border bg-surface">
		<div class="flex items-center justify-between gap-2 border-b border-border px-3 py-2">
			<span class="flex-1 text-xs text-fg-muted"> nick@standup: ~/signup </span>
		</div>
		...
		<div class="px-4 py-6 sm:px-6">
			...
			<p class="mt-1 text-sm text-fg-muted">Redeem your invite to create a standup account.</p>
